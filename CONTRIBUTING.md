...
to make via issue with the maintainers of this repository before making a
change.
...
2. Update the README.md with details of changes to the interface, this includes
   ...
   parameters.
3. You should request review from the maintainers once you submit the Pull
   Request.
...
# Clone the repo
$ git clone https://github.com/<User-Name>/project-nutella.git
# Add upstream remote
$ git remote add upstream https://github.com/dscnitrourkela/project-nutella.git
